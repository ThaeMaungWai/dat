...
<body>
    ...
    <div id="sub_content">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <input type="text" name="id" class="form-control" id="email" value="${sessionScope.res.id}" readonly="readonly">
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
            ...
            <div class="col-md-4">
                <input type="text" name="name" class="form-control" id="email" value="${sessionScope.res.name}">
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
            ...
            <div class="col-md-4">
                <input type="email" name="email" class="form-control" id="email" value="${sessionScope.res.email}">
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
            ...
            <div class="col-md-4">
                <input type="password" name="pas" class="form-control" id="name" value="${sessionScope.res.pas}">
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
            ...
            <div class="col-md-4">
                <input type="password" name="c_pas" class="form-control" id="confirmPassword" value="${sessionScope.res.pas}">
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
        ...
        <div class="row mb-4">
            ...
            <button type="button" class="btn btn-secondary col-md-2 " onclick="location.href = 'ShowUser';">
                Back
            </button>
