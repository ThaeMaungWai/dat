    ...
    <p><b style="color:blue;">${msg}</b></p>
        ...
        %>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" name="id" id="studentID" value="${sessionScope.id}" readonly="readonly">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="file" class="form-control" id="name" name="photo"  onchange="previewPhoto(event)" value="${data.file}">
                </div>
            </div>
            
            <!-- Add this empty img tag to display the uploaded photo -->
        <div class="row mb-4">
        <div class="col-md-2"></div>
        <div class="col-md-4">
        <img id="photoPreview" src="#" alt="Uploaded Photo" style="display: none; max-width: 200px; max-height: 200px;">
       </div>
       </div>
            <!-- This is Test Image Show -->
